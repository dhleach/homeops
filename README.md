...
- **1395 Python tests + 55 React component tests**, GitHub Actions CI, Ruff lint/format enforcement on every PR, and post-deploy public smoke checks
...
├── deploy_demo/                   # Fleet Deploy Lab contracts, state, deployer, and trusted artifact builder
