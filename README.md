...
- **189 pytest tests**, GitHub Actions CI, Ruff lint/format enforcement on every PR
...
189 tests cover observer reconnect logic, consumer event derivation, floor-2 warning timing, thermostat tracking, heating cycle analytics, and consumer state persistence.
