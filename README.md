...
- **Mode-aware dashboard API** — `/api/current-temps` preserves the legacy heating fields and adds null-safe cooling-call, inferred-AC, and per-zone heating/cooling/idle action fields
...
- **1210 Python tests + 34 React component tests**, GitHub Actions CI, Ruff lint/format enforcement on every PR, and post-deploy public smoke checks
